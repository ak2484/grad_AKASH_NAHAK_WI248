...
public class StudentController {
    ...
    public String getAllStudents(@PathVariable int regNo) {
    ...
    public String deleteStudent(@PathVariable int regNo) {
        if (!studRepo.existsByRegNo(regNo)) {
            return "Student with " + regNo + " does not exists ";
        }
        studRepo.deleteByRegNo(regNo);
        return "Sucessfully deleted the students";
    }
    ...
    public List<Student> getStudentsCountByStandard(@RequestParam int standard, @RequestParam Gender gender) {
        return studRepo.findByGenderAndStandard(gender,standard);
    }
